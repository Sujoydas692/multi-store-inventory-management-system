...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                <span class="icon-nav m-0 h5" onclick="MenuBarClickHandler()">
                    <img class="nav-logo-sm mx-2" src="{{asset('assets/images/menu.svg')}}" alt="logo" style="cursor: pointer;"/>
                </span>
                ...
                <div class="user-dropdown">
                    ...
                    <div class="user-dropdown-content ">
                        <div class="mt-4 text-center">
                            <img id="userDropdownAvatar" class="icon-nav-img" src="{{asset('assets/images/user.webp')}}"
                                alt="" />
    ...
    <div id="sideNavRef" class="side-nav-open">
        ...
        <a href="{{url("/customerPage")}}"
            class="side-bar-item {{ request()->routeIs('customer') ? 'side-bar-item-active' : '' }}">
            <i class="bi bi-people"></i>
            <span class="side-bar-item-caption">Customer</span>
        </a>

        <a href="{{url("/categoryPage")}}"
            class="side-bar-item {{ request()->routeIs('category') ? 'side-bar-item-active' : '' }}">
            <i class="bi bi-list-nested"></i>
            <span class="side-bar-item-caption">Category</span>
        </a>

        <a href="{{url("/productPage")}}"
            class="side-bar-item {{ request()->routeIs('product') ? 'side-bar-item-active' : '' }}">
            <i class="bi bi-bag"></i>
        ...
        <a href="{{url('/invoicePage')}}"
            class="side-bar-item {{ request()->routeIs('invoice') ? 'side-bar-item-active' : '' }}">
            <i class="bi bi-receipt"></i>
            <span class="side-bar-item-caption">Invoice</span>
        </a>

        <a href="{{url('/reportPage')}}"
            class="side-bar-item {{ request()->routeIs('report') ? 'side-bar-item-active' : '' }}">
