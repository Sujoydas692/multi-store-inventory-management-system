                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <p class="text-xs mx-0 my-1">Mobile:  <span id="CEmail"></span></p>
...
<script>
    ...
    async function InvoiceDetails(cus_id,inv_id) {
        ...
        showLoader()
        let res=await axios.post("/backend/detail-invoice",{cus_id:cus_id,inv_id:inv_id})
        hideLoader();

        document.getElementById('CName').innerText=res.data['customer']['name']
        document.getElementById('CId').innerText=res.data['customer']['id']
        document.getElementById('CEmail').innerText=res.data['customer']['mobile']
