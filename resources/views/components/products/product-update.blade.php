...
<script>
    ...
    async function UpdateFillCategoryDropDown(){
        let res = await axios.get("/backend/all-category")
    ...
    async function FillUpUpdateForm(id,filePath){
        ...
        let res=await axios.post("/backend/product-by-id",{id:id})
        hideLoader();
    ...
    async function update() {
        ...
        try{
            ...
            showLoader();
            let res = await axios.post("/backend/update-product",formData,config)
            hideLoader();
