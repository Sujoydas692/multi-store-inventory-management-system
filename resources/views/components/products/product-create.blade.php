...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        const response = await fetch('/backend/all-category', {
            method: 'GET',
            headers: {
        ...
        const categories = data.data || data; // depends on backend response
        ...
        alert("Cannot load categories. Check console for details.");
    }
});
    ...
    async function Save() {
        ...
        try {
            ...
            let res = await axios.post("/backend/create-product", formData, config)
            hideLoader();
